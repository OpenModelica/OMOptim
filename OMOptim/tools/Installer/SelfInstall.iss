...
#define VerSrc = "..\..\build\version.txt"
#define SrcDir ""
...
#define test ProcessFileLine()

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{27DD5D97-CBE5-4B81-9301-F9AB50C46380}
AppName=OMOptim
...
OutputBaseFilename=setupOMOptim{#Version}
Compression=lzma
...
Source:  "..\..\bin\omniDynamic416_rt.dll"; DestDir: "{app}";
Source:  "..\..\bin\omniORB416_rt.dll"; DestDir: "{app}";
...
;Source:  "..\..\Doc\OMOptimUsersGuide.pdf"; DestDir: "{app}\doc";
