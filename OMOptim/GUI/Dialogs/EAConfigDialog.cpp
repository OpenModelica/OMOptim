...
EAConfigDialog::EAConfigDialog(EAConfig *_eaConfig)
{
	eaConfig = _eaConfig;
...
QGridLayout* EAConfigDialog::buildLayoutFromEaConfig()
{
	//Adding Layout
...
void EAConfigDialog::pushedCancel()
{
