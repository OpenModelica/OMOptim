...
WidgetResultInfos::WidgetResultInfos(Result *result,QWidget *parent)
    : QWidget(parent), _ui(new Ui::WidgetResultInfosClass)
{
    _ui->setupUi(this);
    _result = result;
...
WidgetResultInfos::~WidgetResultInfos()
{
    delete _ui;
}
