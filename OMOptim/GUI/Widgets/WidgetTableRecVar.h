...
#ifndef WidgetTableRecVar_H
#define WidgetTableRecVar_H
...
class WidgetTableRecVar : public QDialog {
    Q_OBJECT
...
public slots:
    ...
    void updateFromNbScan();

public:
    Ui::WidgetTableRecVarClass *_ui;
    OptimResult* _result;
