...
#define WidgetSelectComponents_H
...
class WidgetSelectComponents : public QWidget {
    Q_OBJECT


public:
	explicit WidgetSelectComponents(Project* _project,Optimization *_problem,QWidget *parent = 0);
...
private :
	...
	ModClassTree *_treeLibrary;
	ModClassTree *_treeModel;
};
