...
private :
    ...
    double _massFlowError; /** relative massflow error accepted in junctions (since MILP results have a limited precision)*/
    double _tempError; /** absolute temperature error accepted in junctions*/
