...
#ifndef _SPEA2PARAMETERS_H
#define _SPEA2PARAMETERS_H
...
public :
  ...
  parameters->addItem(new MOParameter(str(MAXITERATIONS),"Max Iterations",100,MOParameter::INT,1,1000));
