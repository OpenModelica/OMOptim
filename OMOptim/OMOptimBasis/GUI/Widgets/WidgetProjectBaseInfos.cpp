// $Id: WidgetProjectBaseInfos.cpp 11039 2012-02-07 12:47:38Z hubert.thieriot $
/**
 ...
 * Main contributor 2010, Hubert Thierot, CEP - ARMINES (France)
        ...
        @file WidgetProjectBaseInfos.cpp
...
WidgetProjectBaseInfos::WidgetProjectBaseInfos(ProjectBase *project,QList<QAction*> recentProjActions,QWidget *parent) :
    QWidget(parent), _ui(new Ui::WidgetProjectBaseInfos_Class)
{
    _ui->setupUi(this);
...
WidgetProjectBaseInfos::~WidgetProjectBaseInfos()
{
    delete _ui;
}

void WidgetProjectBaseInfos::actualizeGuiFromProject()
{
...
void WidgetProjectBaseInfos::openFolder()
{
