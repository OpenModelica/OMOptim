// $Id: DlgSelectFiles.cpp 9677 2011-08-24 13:09:00Z hubert.thieriot $
/**
    ...
    :_files(filesList),QDialog(parent)
{
    ...
    listLayout->addWidget(_widgetSelectFiles);
...
void DlgSelectFiles::pushedOk()
{
    _files = _filesLocal;
    accept();
}

void DlgSelectFiles::pushedCancel()
{
    reject();
}
